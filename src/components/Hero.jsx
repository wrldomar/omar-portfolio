        ...
        <section id="hero" className="hero section">
            <div className="container">
                <div className="hero-content fade-in">
                    ...
                    <h2 className="title">Full-Stack Developer & Engineering Student</h2>
                    <p className="summary">
                        Passionate about artificial intelligence, web development, and emerging technologies. Building high-quality solutions and innovating for the future.
                    </p>
